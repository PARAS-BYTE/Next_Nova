  ...
  return (
    <div className="min-h-screen overflow-hidden relative flex items-center justify-center" style={{ background: palette.bg }}>
      ...
      <div className="text-center relative z-10">
        ...
        <Link href="/" className="inline-flex items-center gap-2 px-6 py-3 rounded-lg shadow-lg transition-all duration-300" style={{ background: palette.accent, color: palette.card }} onMouseEnter={(e) => e.currentTarget.style.background = palette.accentDeep} onMouseLeave={(e) => e.currentTarget.style.background = palette.accent}>
