...
const Login = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden relative flex items-center justify-center p-4" style={{ background: palette.bg }}>
      ...
      >
        {/* Back Button */}
        <Link href="/" className="absolute -top-16 left-0 flex items-center gap-2 transition-colors" style={{ color: palette.text2 }} onMouseEnter={(e) => e.currentTarget.style.color = palette.text} onMouseLeave={(e) => e.currentTarget.style.color = palette.text2}>
