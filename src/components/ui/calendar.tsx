  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-black hover:bg-gray-100"),
        day_range_end: "day-range-end",
        day_selected:
          "bg-black text-white hover:bg-gray-800 hover:text-white focus:bg-black focus:text-white",
